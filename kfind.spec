...
Source0  : https://download.kde.org/stable/release-service/24.02.1/src/kfind-24.02.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.02.1/src/kfind-24.02.1.tar.xz.sig
...
%prep
%setup -q -n kfind-24.02.1
cd %{_builddir}/kfind-24.02.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1711089080
mkdir -p clr-build
pushd clr-build
