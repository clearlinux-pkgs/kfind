...
Source0  : https://download.kde.org/stable/release-service/24.05.0/src/kfind-24.05.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.05.0/src/kfind-24.05.0.tar.xz.sig
...
%setup -q -n kfind-24.05.0
cd %{_builddir}/kfind-24.05.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1716576870
mkdir -p clr-build
pushd clr-build
