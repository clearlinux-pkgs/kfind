...
Source0  : https://download.kde.org/stable/release-service/21.12.1/src/kfind-21.12.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/21.12.1/src/kfind-21.12.1.tar.xz.sig
...
%prep
%setup -q -n kfind-21.12.1
cd %{_builddir}/kfind-21.12.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1641966003
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kfind-21.12.1/CMakePresets.json.license %{buildroot}/usr/share/package-licenses/kfind/29fb05b49e12a380545499938c4879440bd8851e
cp %{_builddir}/kfind-21.12.1/LICENSES/GPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/kfind/3e8971c6c5f16674958913a94a36b1ea7a00ac46
pushd clr-build
%make_install
popd
%find_lang kfind
