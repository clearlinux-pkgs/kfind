...
Version  : 19.12.1
Release  : 19
URL      : https://download.kde.org/stable/release-service/19.12.1/src/kfind-19.12.1.tar.xz
Source0  : https://download.kde.org/stable/release-service/19.12.1/src/kfind-19.12.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/19.12.1/src/kfind-19.12.1.tar.xz.sig
...
%prep
%setup -q -n kfind-19.12.1
cd %{_builddir}/kfind-19.12.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1578614858
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kfind-19.12.1/COPYING %{buildroot}/usr/share/package-licenses/kfind/4cc77b90af91e615a64ae04893fdffa7939db84c
cp %{_builddir}/kfind-19.12.1/COPYING.DOC %{buildroot}/usr/share/package-licenses/kfind/e1d31e42d2a477d6def889000aa8ffc251f2354c
cp %{_builddir}/kfind-19.12.1/src/COPYING %{buildroot}/usr/share/package-licenses/kfind/7c203dee3a03037da436df03c4b25b659c073976
cp %{_builddir}/kfind-19.12.1/src/COPYING.DOC %{buildroot}/usr/share/package-licenses/kfind/bd75d59f9d7d9731bfabdc48ecd19e704d218e38
pushd clr-build
%make_install
popd
%find_lang kfind
